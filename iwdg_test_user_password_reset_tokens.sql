...
CREATE TABLE `user_password_reset_tokens` (
  ...
  `token_expiration_timestamp` bigint(20) DEFAULT NULL,
  ...
  CONSTRAINT `user` FOREIGN KEY (`user`) REFERENCES `users` (`user`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-11-16 12:42:40
