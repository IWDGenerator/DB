...
CREATE TABLE `common_questions` (
  ...
  `question` text,
  `answer` text,
  `inserted_utc` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_utc` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-11-16 12:43:06
